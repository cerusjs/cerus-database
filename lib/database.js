		...
		self_.table = function(name) {
			...
			self_.insert = function(row) {
				if(typeof row !== "object") {
					throw new TypeError("argument row must be a string");
				}
			...
			self_.modify = function(query, change) {
				if(typeof query !== "object") {
					throw new TypeError("argument query must be a string");
				}
				
				if(typeof change !== "object") {
					throw new TypeError("argument change must be a string");
				}
